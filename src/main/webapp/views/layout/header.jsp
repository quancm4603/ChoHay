            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav d-lg-flex ms-auto justify-content-lg-center align-items-lg-center mb-2 mb-lg-0">
                    ...
                    <li class="nav-item d-flex justify-content-xxl-center align-items-xxl-center quanlytin" style="width: 100%;height: 100%;padding: 5px;">
                        <a class="nav-link d-lg-flex d-xxl-flex justify-content-lg-center align-items-lg-center justify-content-xxl-center align-items-xxl-center" href="./user" style="padding: 0px;"><img class="rounded-circle" style="width: 24px;height: 24px; object-fit: cover;" src="<%=user.getAvatar()%>"><span class="text-capitalize spanquanly" style="line-height: 15px;overflow: hidden;width: 16vh;text-overflow: ellipsis;"><%=user.getFullName()%></span></a>
                    </li>
