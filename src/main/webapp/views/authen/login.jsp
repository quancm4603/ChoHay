...
<html data-bs-theme="light" lang="en">
    ...
    <body>
        <section class="position-relative py-4 py-xl-5" style="height: auto;border-radius: 0px;">
                        ...
                        <div class="card mb-5" style="width: 100%;height: 100%;">
                            <div class="card-body d-flex flex-column align-items-center" style="padding: 0px;padding-bottom: 47px;box-shadow: 0px 0px 10px;width: 100%;height: 100%;">
                                ...
                                <form class="text-center" method="post" style="width: 60%;height: 100%;">
                                    <div class="mb-3" style="width: 100%;"><input name="username" class="form-control" type="text" placeholder="Email or Username" required="" style="border-width: 1px;border-color: var(--bs-emphasis-color);"></div>
