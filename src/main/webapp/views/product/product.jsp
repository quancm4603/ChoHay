                        ...
                        <div class="row">
                            <div class="col-md-5 col-lg-6" style="padding: 5px 0 0 0;display: flex;width: 100%;height: 80.1px;">
                                <span style="box-sizing: border-box;display: block;width: 25%;height: initial;background: none;opacity: 1;border: 0px;margin: 0px;padding: 0px;max-width: 100%;">
                                    <img src="<%=shop.getAvatar()%>" class="rounded-circle" style="display: block;width: 90px;height: 90px;object-fit: cover;background: none;opacity: 1;border: 0px;padding: 0px;">
                                </span>
                                <div style="width: 100%;display: flex;">
                                    <span style="font-size: 19px;font-weight: bold;margin: 0px;"><%=shop.getFullName()%></span>
