...
//            FileInputStream serviceAccount = new FileInputStream("/chohay-76cc5.json");
            ...
            String bucketName = "chohay-76cc5.appspot.com";
            ...
            BlobId blobId = BlobId.of(bucketName, "destination/folder/" + Paths.get(filePart.getSubmittedFileName()).getFileName().toString());
            ...
            System.out.println("File URL: " + signedUrl.toString());

            //set image link
            product.setImage(signedUrl.toString());
