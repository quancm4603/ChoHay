 ...
 * @author caomi
 */
@WebServlet(name="SetDeliveredSellController", urlPatterns={"/set-delivered-sell"})
public class SetDeliveredSellController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            if (userId == orderService.getOrderById(orderId).getSellerId()) {
                ...
                session.setAttribute("sellStatus", "Xác nhận thành công, đơn hàng đã chuyển về mục ĐÃ GIAO");
            }
